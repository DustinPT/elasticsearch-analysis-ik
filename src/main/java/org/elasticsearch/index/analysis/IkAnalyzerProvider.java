...
public class IkAnalyzerProvider extends AbstractIndexAnalyzerProvider<IKAnalyzer> {
    ...
    public IkAnalyzerProvider(IndexSettings indexSettings, Environment env, String name, Settings settings,boolean useSmart,boolean keepPunctuations) {
        super(indexSettings, name, settings);

        Configuration configuration=new Configuration(env,settings).setUseSmart(useSmart).setKeepPunctuations(keepPunctuations);
    ...
    public static IkAnalyzerProvider getIkSmartKpAnalyzerProvider(IndexSettings indexSettings, Environment env, String name, Settings settings) {
    ...
    public static IkAnalyzerProvider getIkKpAnalyzerProvider(IndexSettings indexSettings, Environment env, String name, Settings settings) {
